    ...
    <Layout>
      ...
      <View style={styles.scroll}>
        <Container style={styles.container}>
          ...
          <Divider />
          <Content>
            <ContentSection show={showSection}>
              <SectionTitleRow>
                ...
                <TouchableWithoutFeedback
                  ...
                  <Icon
                    {...{width: 24, height: 24, fill: 'rgb(162,170,189)'}}
                    name={
                      showSection
                        ? 'chevron-up-outline'
            ...
            <ContentSection show={showSection2}>
              <SectionTitleRow>
